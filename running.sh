...
# Author  : Yth AJIKCOBAIN
# (C) Copyright 2022-2023 By AJIKCOBAIN
# =========================================
...
echo -e "         OWNER : ${GREEN}AJIKCOBAIN ${NC}${YELLOW}(${NC} ${GREEN}envy ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By COBAIN ${YELLOW}(${NC} 2021-2022 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
